...
\	imul   %edx,%eax
\	0xf c, $a4 c, $00 c, $48 c,
\	test   $0xc2,%rax
\	test   $0xc2,%eax
\	test   $0xc2,%al
\	movabs 0x807060504030201,%al
\	movabs 0x807060504030201,%eax
\	movabs %al,0x807060504030201
\	movabs %eax,0x807060504030201

	.byte 0xA0,1,2,3,4,5,6,7,8
	.byte 0xA1,1,2,3,4,5,6,7,8
	.byte 0xA2,1,2,3,4,5,6,7,8
